...
export const projects = [
  ...
  {
    label: "Pseudo Lambda",
    text: "This is my take on a mock of AWS Lambda for serverless code execution. This project was undertaken to familiarize myself with the major problems and ideas behind modern distributed computing. Concepts include (but are definitely not limited to) leader election, task scheduling, fault tolerance and recovery, and logging.",
